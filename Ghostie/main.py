...
ghostie = Message(WIDTH // 2 + 50, HEIGHT // 2 - 90, 90, "Ghostie", title_font, (255, 255, 255), win)
...
controls_btn = Button(WIDTH // 2 - bwidth // 4, HEIGHT // 2 + 35, ButtonBG, 0.5, controls, 10)
exit_btn = Button(WIDTH // 2 - bwidth // 4, HEIGHT // 2 + 75, ButtonBG, 0.5, exit, 10)
